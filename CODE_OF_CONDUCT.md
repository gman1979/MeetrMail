...
The maintainers of MeetrMail share the dual responsibility of leading by example and enforcing these policies as necessary to maintain an open and welcoming environment. All community members should be excellent to each other.

## Scope

This Code of Conduct applies to all places where MeetrMail community activity is occurring, including on GitHub, in discussion forums, on Slack, on social media, and in real life. The Code of Conduct applies not only on websites/at events run by the MeetrMail community (e.g. our GitHub organization, our Slack team) but also at any other location where the MeetrMail community is present (e.g. in issues of other GitHub organizations where MeetrMail community members are discussing problems related to MeetrMail, or real-life professional conferences), or whenever a MeetrMail community member is representing MeetrMail to the public at large or acting on behalf of MeetrMail.

This code does not apply to activity on a server running MeetrMail software, unless your server is hosting a service for the MeetrMail community at large.
...
Because the need for confidentiality for all parties involved in an enforcement action outweighs the goals of openness, limited information will be shared with the MeetrMail community regarding enforcement actions that have taken place.
