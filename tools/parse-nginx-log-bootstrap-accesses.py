#!/usr/bin/python3
#
# This is a tool Josh uses on his box serving meetrmail.net to parse the nginx
# access log to see how many people are installing MeetrMail each day, by
...
outfn = "/home/user-data/www/meetrmail.net/install-stats.json"
