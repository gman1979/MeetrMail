...
echo
echo "WARNING: you could break meetrmail when fiddling around with Nextcloud's admin interface"
echo "If in doubt, press CTRL-C to cancel."
echo
echo "Press enter to continue."
read

sudo -u www-data "php$PHP_VERSION" /usr/local/lib/owncloud/occ group:adduser admin "$ADMIN" && echo "Done."
